...
<div id="qna_wrap">
	<div class="qnaQ">
		<div class="qna_w">
			<em >Q</em>
			<div class="q_text"><p id="qustion" style="color:blue;line-height:30px;font-size:24px;text-align:center;display: block ;"><%=oneline%> </p></div>
		</div>
	</div>
	
	<div class="qnaQ" id="answer" style="display: none;">
		<div class="qna_w" style="background:skyblue;border:none;">
			<div class="q_text"><p style="color:blue; font-size:30px; text-align:center;"><%=before_split%> </p></div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function check(){
			...
			/* 
				...
				let blank_txt =document.getElementById("blank_txt").innerHTML="둘다 틀렸습니다";
			    speech(speak.innerHTML);
	        	 ...
	        	 /*  document.getElementById("check1").value="정답입니다";
					...
					let blank_txt =document.getElementById("blank_txt").innerHTML="정답입니다 !";
				    speech(speak.innerHTML);
	          }	
	          else if (one1 != one && two2==two){
	        	/*   document.getElementById("check1").value="틀렸습니다";
				 document.getElementById("check2").value="정답입니다"; */
				let blank_txt =document.getElementById("blank_txt").innerHTML="첫번쨰 빈칸이 틀렸습니다 ";
			    speech(speak.innerHTML);
	          }
	        	...
	        	/*   document.getElementById("check1").value="정답입니다";
					document.getElementById("check2").value="틀렸습니다"; */
					let blank_txt =document.getElementById("blank_txt").innerHTML="두번쨰 빈칸이 틀렸습니다 ";
				    speech(speak.innerHTML);
