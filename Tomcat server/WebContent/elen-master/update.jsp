...
:root{
	...
	--font-color: #4e4e4e;
	--border-gray-color :#e83e8cd1;
	--naver-green-color:#e83e8cd1;
	--naver-green-border-color: #e83e8cd1;
}
  ...
  <body>
	...
	<div id="colorlib-page" >
		...
		<div id="colorlib-main">
			<div class="hero-wrap js-fullheight" style="background-image:url(images/8.jpg); " data-stellar-background-ratio="0.5">
				<div class="overlay"></div>
				<div class="js-fullheight d-flex justify-content-center align-items-center">
					<div class="col-md-8 text text-center">
						
							<h1  style = " font-size:3.5em; color:#e83e8cd1">Imagine <span style="color:#FE9A2E">Learn</span></h1>
	...
	<div class="main-container">
		...
		<section class="login-input-section-wrap">
			...
			<div class="login-input-wrap password-wrap">	
				<input placeholder="변경할 비밀번호를 입력해주세요" type="password" name="pw"></input>
			</div>
			<div class="login-input-wrap password-wrap">	
				<input placeholder="변경할 이메일을 입력해주세요" type="text"name="email"></input>
